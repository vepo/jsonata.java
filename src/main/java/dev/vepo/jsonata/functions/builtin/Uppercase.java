...
/**
 * JSONata built-in {@code $uppercase}. Returns the argument converted to uppercase. Uses context when none is supplied.
 *
...
public record Uppercase(List<Mapping> providers,
    ...
    public Data map(Data original, Data current) {
        ...
        return JsonFactory.stringValue(arg.toJson().asText().toUpperCase());
    }
}
