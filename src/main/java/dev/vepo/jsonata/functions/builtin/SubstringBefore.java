...
/**
 * JSONata built-in {@code $substringBefore}. Returns the portion of a string before the first occurrence of a pattern.
 *
...
public record SubstringBefore(List<Mapping> providers,
    ...
    public Data map(Data original, Data current) {
        ...
        return JsonFactory.stringValue(index >= 0 ? value.substring(0, index) : value);
    }
}
