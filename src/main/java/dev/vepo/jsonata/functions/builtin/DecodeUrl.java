...
/**
 * JSONata built-in {@code $decodeUrl}. URL-decodes a string. Uses context as the argument when none is supplied.
 *
 ...
 */
public record DecodeUrl(List<Mapping> providers, List<DeclaredFunction> declaredFunctions) implements Mapping {
